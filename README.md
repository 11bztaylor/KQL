.create-or-alter function
  ...
  CommonSecurityLog_parse() {
    ...
    | extend _ext  = replace_string(strcat_array(array_slice(_p, 7, -1), '|'), '<TZPIPE>', '|')
    ...
    | project
    TimeGenerated,
    Activity = replace_string(tostring(_p[5]), '<TZPIPE>', '|'),
    ...
    DeviceEventClassID = replace_string(tostring(_p[4]), '<TZPIPE>', '|'),
    ...
    DeviceProduct = replace_string(tostring(_p[2]), '<TZPIPE>', '|'),
    DeviceTimeZone = ['dtz'],
    DeviceTranslatedAddress = ['deviceTranslatedAddress'],
    DeviceVendor = replace_string(tostring(_p[1]), '<TZPIPE>', '|'),
    DeviceVersion = replace_string(tostring(_p[3]), '<TZPIPE>', '|'),
    EndTime = ['end'],
    EventCount = ['cnt'],
    ...
    IndicatorThreatType = "",
    LogSeverity = replace_string(tostring(_p[6]), '<TZPIPE>', '|'),
    MaliciousIP = "",
    MaliciousIPCountry = "",
